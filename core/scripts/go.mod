...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.0.0-20250215021556-39337c1d0a71 // indirect
	...
	github.com/smartcontractkit/chainlink-solana v1.1.2-0.20250215132349-cba7b51d385b // indirect
